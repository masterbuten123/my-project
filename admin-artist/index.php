...
// --- Fetch Totals ---
// Total Users
$userQuery = "SELECT COUNT(*) AS total_users FROM accounts WHERE role='user'";
...
foreach ($months as $month) {
    $query = "SELECT COUNT(*) AS total FROM accounts WHERE role='user' AND DATE_FORMAT(created_at, '%Y-%m') = '$month'";
